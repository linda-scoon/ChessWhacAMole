...
export default class Queen extends chessPiece {
  ...
  left(row, col) {
    ...
    console.log("Rook left() ended.");
  }

  right(row, col) {
    var sideSteps = 1;

    console.log("Rook Running right()");
    ...
    console.log("Rook right() ended.");
  }

  down(row, col) {
    var downSteps = 1;

    console.log("Rook Running down()");
  ...
  up(row, col) {
    ...
    if (up <= boardSize) {
      ...
      allowedMoves.set("Rook up", up, col);
      console.log("Rook up: row = " + up + ", " + " col = " + col);
      allowedMoves.set("up", col + up);
    }
    console.log("Rook up() finished.");
  }
   ...
   */
  checkMoves(col, row) {
    console.log("Rook checkMoves(col,row) started.");

    allowedMoves.clear();
    console.log("Rook allowedMoves variable cleared.");
